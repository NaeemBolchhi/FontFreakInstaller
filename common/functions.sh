...
cleanup() {
  ...
  ui_print "| CFI by nongthaihoang @ XDA"
  ui_print " "
  ui_print "| Brought to you by Font Freak"
  ui_print "| https://font-freak.github.io"
  ui_print "| https://t.me/FontFreak"
  ui_print " "
}
...
[ -f "$MODPATH/common/choice.sh" ] && . $MODPATH/common/choice.sh
